...
const Header = () => {
  ...
  return (
    <header
      className="w-full min-h-[12rem] md:h-64 bg-[url('/Images/headerBackground/bg3.jpg')] bg-cover bg-center flex items-start justify-center shadow-lg shadow-gray-800 transition-all duration-1000"
